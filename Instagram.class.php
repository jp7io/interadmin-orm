...
class Instagram
{
     ...
     * @param int [optional] $limit Limit of returned results
     *
     * @return mixed
     */
     ...
     * @param bool [optional] $token If it's true, only the access token will be returned
     *
     * @return mixed
     */
    public function getOAuthToken($code, $token = false)
    {
        $apiData = array('grant_type' => 'authorization_code', 'client_id' => $this->getApiKey(), 'client_secret' => $this->getApiSecret(), 'redirect_uri' => $this->getApiCallback(), 'code' => $code);
     ...
     * @param bool [optional]  $auth     Whether the function requires an access token
     *
     * @return mixed
     */
