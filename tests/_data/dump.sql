...
CREATE TABLE `interadmin_teste_tipos` (
  ...
  `files_ajuda` varchar(255) NOT NULL DEFAULT '',
  `files_2` varchar(50) NOT NULL DEFAULT '',
  `files_2_ajuda` varchar(255) NOT NULL DEFAULT '',
  `files_3` varchar(50) NOT NULL DEFAULT '',
  `files_3_ajuda` varchar(255) NOT NULL DEFAULT '',
  ...
  `log` text NOT NULL,
  `deleted_type` char(1) NOT NULL DEFAULT '',
