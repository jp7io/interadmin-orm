...
This is a list of all HTTP request headers.
    ...
    public static function phpini()
    {
        ...
        ?>
<div class="krumo-title">
This is a list of the configuration settings read from <code><b><?php echo get_cfg_var('cfg_file_path');
        ?></b></code>.
</div>
		<?php
...
This is a list of all the values from the <code><b>$_SESSION</b></code> array.
    ...
    public static function ini($ini_file)
    {
        ...
        ?>
<div class="krumo-title">
This is a list of all the values from the <code><b><?php echo realpath($ini_file) ? realpath($ini_file) : $ini_file;
        ?></b></code> INI file.
</div>
		<?php
        return self::dump($_);
    ...
    public static function dump($data)
    {
        ...
        $_ = debug_backtrace();
        while ($d = array_pop($_)) {
            if (strToLower($d['function']) == 'krumo' || strToLower($d['function']) == 'kd' || strToLower(@$d['class']) == 'krumo') {
                break;
            }
        }
	...
	<ul class="krumo-node krumo-first">
		...
		<li class="krumo-footnote">
			<div class="krumo-version" style="white-space:nowrap;">
				<h6>Krumo version <?php echo self::version();
        ?></h6> | <a
...
<li class="krumo-child">
	<div class="krumo-element"
		...
		onMouseOut="krumo.out(this);">
			...
			<a class="krumo-name"><?php echo $name;
        ?></a>
...
<li class="krumo-child">
	...
	<div class="krumo-element<?php echo self::$open ? ' krumo-opened' : '';
        ?><?php echo count($data) > 0 ? ' krumo-expand' : '';
        ?>"
		<?php if (count($data) > 0) {
    ?> onClick="krumo.toggle(this);"<?php
		...
		onMouseOut="krumo.out(this);">
			...
			<a class="krumo-name"><?php echo $name;
        ?></a>
			(<em class="krumo-type">Array, <strong class="krumo-array-length"><?php echo($count == 1)
                    ? ('1 element')
                    : ($count.' elements');
        ?></strong></em>)
	...
	<?php if (count($data)) {
    self::_vars($data, self::$open || $name == 'attributes');
}
        ?>
</li>
<?php
...
<li class="krumo-child">
    ...
    ?> onClick="krumo.toggle(this);"<?php
        ...
        ?></a>
			...
			<strong class="krumo-class"><?php echo get_class($data).self::getStringValue($data);
        ?></strong>
	</div>
...
<li class="krumo-child">
	...
	<div class="krumo-element"
        ...
        ?></a>
			...
			<strong class="krumo-resource"><?php echo get_resource_type($data);
        ?></strong>
	</div>
...
<li class="krumo-child">
	...
	<div class="krumo-element"
        ...
        ?></a>
			...
			<strong class="krumo-integer"><?php echo $data;
        ?></strong>
	</div>
...
<li class="krumo-child">
	...
	<div class="krumo-element <?php if ($innerdata) {
    ?>krumo-expand" onclick="krumo.toggle(this);<?php
		...
		onMouseOut="krumo.out(this);">
			...
			<a class="krumo-name"><big>&#8734;</big> <em class="krumo-type">Recursion</em> (<?php echo $name;
        ?>)</a>
			(<em class="krumo-type"><?php echo gettype($data);
        ?></em>)
...
<li class="krumo-child">
	...
	<div class="krumo-element"
        ...
        ?></a>
			...
			<strong class="krumo-float"><?php echo $data;
        ?></strong>
	</div>
